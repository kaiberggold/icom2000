// Covers icom::config::File (parsing, get/getUint/getList, the
...
int main() {
    ...
    testGetReturnsDefaultWhenAbsent();
    testGetListSplitsAndTrimsCommas();
    testGetListEmptyWhenKeyAbsent();
    testParseRejectsKeyOutsideAnySection();
    testParseRejectsMalformedSectionHeader();
    testParseRejectsLineWithoutEqualsOrSection();
    testLoadMissingFileIsNotAnError();
    testStationRegistryFallsBackToDoorAndInsideWhenUnconfigured();
